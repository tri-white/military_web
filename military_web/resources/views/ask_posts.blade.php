                     ...
                     <div class="d-flex justify-content-between mb-2 mt-2">
                         ...
                         <div class="col-lg-6">
                             <select id="product-sort" name="product-sort" class="form-select" aria-label="Категорія"
                                 ...
                                 <option value="pumm-asc">По сумі яка залишилася (грн) (↑)</option>
    ...
    <ul class="pagination justify-content-center">
        @for ($page = 1; $page <= $totalPages; $page++)
            <li class="page-item{{ $page == $currentPage ? ' active' : '' }}">
                <a class="page-link text-white" href="{{ route('ask-posts', ['page' => $page]) }}" style="background-color:#B5C186">{{ $page }}</a>
            </li>
        @endfor
    </ul>
</nav>
