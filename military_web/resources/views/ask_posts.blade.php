                     ...
                     <div class="d-flex justify-content-between mb-2 mt-2">
                         ...
                         <div class="col-lg-6">
                             <select id="product-sort" name="product-sort" class="form-select" aria-label="Категорія"
                                 style="width:100%">
                                 <option value="propositions-desc" {{ $selectedSort == 'propositions-desc' ? 'selected' : '' }}>По кількості пропозицій (↓)</option>
                                 <option value="propositions-asc" {{ $selectedSort == 'propositions-asc' ? 'selected' : '' }}>По кількості пропозицій (↑)</option>
